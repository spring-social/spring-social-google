 ...
 * Requires OAuth2 authentication with either "https://www.googleapis.com/auth/tasks" for read and write operations 
 * or "https://www.googleapis.com/auth/tasks.readonly" for read-only operations.
 * @author Gabriel Axel
 */
public interface TaskOperations {
	 ...
	 * @param id the task list ID or "@default"
	 ...
	 * @param taskList the task list to create or update
	 ...
	 * @param taskListId the containing task list ID
	 * @param id the task ID
	 * @return the retrieved {@link Task}
	 */
	 ...
	 * Deleted tasks can be retrieved using {@link TaskQueryBuilder#includeDeleted(boolean)}.
	 ...
	 * @param taskListId the containing task list
	 * @param parent task ID to become parent of the new task
	 * @param previous the task ID after which the new task will be appended
	 ...
	 * @param parent the task ID to become parent of the moved task
	 * @param previous the task ID after which the moved task will be appended
	 * @return the moved {@link Task}
	 * @throws IllegalStateException if both 'parent' and 'previous' arguments are empty
	 */
	Task moveTask(String taskListId, Task task, String parent, String previous);
	
	/**
	 * Hides completed tasks from a task list.
	 * Hidden tasks can be retrieved using {@link TaskQueryBuilder#includeHidden(boolean)}.
	 * @param taskList the task list to clear
	 */
