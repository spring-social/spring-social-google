		...
		<div class="row">
			<div class="span14 columns offset2">
				...
				<form action="signin/google" method="POST">
				    ...
				    <input type="hidden" name="scope" value="https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo#email https://www.googleapis.com/auth/plus.me https://www.google.com/m8/feeds https://picasaweb.google.com/data/" />		    
				</form>
			</div>
		</div>
	</div>
